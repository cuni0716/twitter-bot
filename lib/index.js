...
var TWITTER_SEARCH_PHRASE = '#reduxjs OR #ecmascript OR #expressjs OR #reactjs OR #nodejs';
var TWO_HOURS = 120 * 60 * 1000;
var COUNT = 100;
var RESULT_TYPE = 'recent';
var LANG = 'en';
var RETWEETED = [];

var Bot = new _twitter2.default({
...
function Retweet() {
  ...
  Bot.get('search/tweets', query, function (error, data, response) {
    ...
    tweets.forEach(function (twit) {
      var rating = (0, _helpers.calculateRating)(twit);
